...
#define 	VIC0VECTADDR			( *((volatile unsigned long *)(VIC0_BASE + 0x100)) )
...
#define 	VIC1VECTADDR			( *((volatile unsigned long *)(VIC1_BASE + 0x100)) )
...
#define 	VIC2VECTADDR			( *((volatile unsigned long *)(VIC2_BASE + 0x100)) )
...
#define 	VIC3VECTADDR			( *((volatile unsigned long *)(VIC3_BASE + 0x100)) )
